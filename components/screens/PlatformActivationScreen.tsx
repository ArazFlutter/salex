...
export const PlatformActivationScreen = ({
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="px-4 pt-5 pb-6 h-screen flex flex-col relative">
      ...
      {!isStep1 && (
        <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-[#F7F8FC] via-[#F7F8FC] to-transparent px-6 pt-4 pb-[calc(env(safe-area-inset-bottom)+1.5rem)]">
          <Button 
