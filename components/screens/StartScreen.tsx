...
export const StartScreen = ({ onNavigate }: StartScreenProps) => {
  ...
  return (
    <motion.div initial={false} animate={{ opacity: 1 }} className="flex flex-col items-center justify-between h-screen p-6 text-center bg-gradient-to-b from-[#5B5CFF] to-[#7A7BFF] text-white">
