...
export function mapNormalizedListingToBirjacom(listing: NormalizedListing): BirjacomPayload {
  const t = requireTaxonomy(listing);

  return {
    listingId: requireText('Birja.com', 'id', listing.id),
    title: requireText('Birja.com', 'title', listing.title),
    price: requireNumber('Birja.com', 'price', listing.price),
    city: requireText('Birja.com', 'city', listing.city),
    description: requireText('Birja.com', 'description', listing.description),
